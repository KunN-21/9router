...
// by declaring the named quirk in providers/registry/{id}.js (openai, azure, github,
// codex, grok-cli). Applied only on the Responses→Chat hop (see translator/index.js);
