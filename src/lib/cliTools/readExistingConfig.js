 ...
 * as `{}` silently replaces it — for `config.toml` it discards every provider,
 * MCP server and approval policy the user had, and for the Copilot provider array
 * it drops every other model provider the user had configured.
 *
